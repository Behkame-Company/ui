<template>
    <div class="ui-card" :class="size_class">
        <img v-if="image" :src="image" alt="Card image" class="ui-card-image" />
        ...
        <div class="ui-card-footer" v-if="$slots.footer">
            <slot name="footer" :button-class="`${buttonClass} ${buttonColorClass}`"></slot>
        </div>
    </div>
</template>
...
const size_class = computed<string>(() => `ui-card-${props.size}`)
...
const size_icon = computed<number>(() => {
    switch (props.size) {
        case 'xl': return 28;
        case 'lg': return 24;
        case 'md': return 22;
...
.ui-card-header-icon{
    @apply cursor-pointer  text-gray-shade-800;
}
/* shadow */
...
/* Header font sizes */
.ui-card-header-sm { @apply text-sm font-bold; }
.ui-card-header-md { @apply text-base font-bold; }
.ui-card-header-lg { @apply text-h6 font-semibold; }
.ui-card-header-xl { @apply text-h5 font-semibold; }

/* Body font sizes */
.ui-card-body-sm { @apply text-2xs; }
.ui-card-body-md { @apply text-xs; }
.ui-card-body-lg { @apply text-sm; }
.ui-card-body-xl { @apply text-base; }



.ui-card-sm { @apply p-2; }
.ui-card-md { @apply p-3; }
.ui-card-lg { @apply p-4; }
.ui-card-xl { @apply p-4; }

.ui-card-button-primary{ @apply bg-primary  text-white; }
.ui-card-button-success{ @apply bg-success  text-white; }
.ui-card-button-warning{ @apply bg-warning  text-white; }
.ui-card-button-danger{ @apply bg-error  text-white; }
.ui-card-button-info{ @apply bg-info  text-white; }
.ui-card-button-gray{ @apply bg-gray  text-white; }
