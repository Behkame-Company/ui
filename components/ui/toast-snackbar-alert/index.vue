...
const props = defineProps({
  ...
  body_text: { type: String, default: "" },
    ...
    validator: (value: string) =>
      ["primary", "outline", "dark", "error", "success", "warning", "info"].includes(value),
  },
  ...
  prefix_icon: { type: String, default: "" },

  // Optional cancel icon (shown when auto_dismiss is false)
  cancel_icon: { type: String, default: "" },
...
/* === Color Schemes === */
.ui-toast-primary         { @apply text-white bg-primary border-primary; }
.ui-toast-body-primary    { @apply text-shade-800 bg-blue-50 border-tint-400; }

.ui-toast-outline         { @apply text-shade-600 bg-white border-tint-400; }
.ui-toast-body-outline    { @apply text-shade-800 bg-white border-tint-400; }

.ui-toast-dark            { @apply text-white bg-shade-600 border-tint-400; }
.ui-toast-body-dark       { @apply text-shade-800 bg-tint-50 border-tint-400; }

.ui-toast-error           { @apply text-white bg-error border-tint-400; }
.ui-toast-body-error      { @apply text-shade-800 bg-red-50 border-tint-400; }

.ui-toast-success         { @apply text-white bg-success border-tint-400; }
.ui-toast-body-success    { @apply text-shade-800 bg-green-50 border-tint-400; }

.ui-toast-warning         { @apply text-white bg-warning border-tint-400; }
.ui-toast-body-warning    { @apply text-shade-800 bg-yellow-50 border-tint-400; }

.ui-toast-info            { @apply text-white bg-info border-tint-400; }
.ui-toast-body-info       { @apply text-shade-800 bg-purple-50 border-tint-400; }
</style>
