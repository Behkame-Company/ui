...
<template>
  <div class="ui-list__card">
    <div class="ui-list__title">{{ title }}</div>
    <ul>
      <li
        ...
        class="ui-list__item"
        :class="[
          idx === selected ? 'ui-list__item__selected' : 'ui-list__item__hover',
          idx !== items.length - 1 ? 'ui-list__item__border' : '',
        ]"
